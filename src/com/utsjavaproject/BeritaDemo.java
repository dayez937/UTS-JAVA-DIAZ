...
public class BeritaDemo implements Berita {
    @Override
    public void Judul() {
        System.out.println("Lanjut, Gerakan Buruh Jakarta Besok Demo Tolak Omnibus Law \n");
    }

    @Override
    public void Isi() {
        System.out.println("Gerakan Buruh Jakarta (GBJ) dikabarkan siap melakukan demo. Demo tersebut masih dengan tema yang sama yakni menolak omnibus law Undang-Undang Cipta Kerja.\n" +
                "\n" +
                "Rencananya, demo akan dilakukan di depan Istana Merdeka, Jakarta Pusat.\n" +
                "\n" +
                "Gerakan Buruh Jakarta terdiri atas aliansi serikat pekerja/buruh yang berkedudukan di Jakarta. Koordinator lapangan GBJ, Supardi, mengatakan pihaknya sudah menyampaikan surat pemberitahuan kepada Polda Metro Jaya. Pihak kepolisian pun mengingatkan akan adanya potensi besar klaster Corona karena demonstrasi.\n" +
                        "\n" +
                        "\"Iya betul (demo). Pemberitahuan aja, udah ke Polda. Sudah ada respons sih, tapi kan kondisinya situasional,\" kata Supardi saat dihubungi detikcom, Rabu (14/10/2020).\n" +
                        "\n" +
